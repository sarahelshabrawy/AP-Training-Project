...
class Ui_DifferencesWindow(QMainWindow):
    def setupUi(self):
        ...
        self.title = QtWidgets.QLabel("<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">Spot the differences Game</span></p></body></html>", self.centralwidget)
        ...
        self.number = QtWidgets.QLabel("<html><head/><body><p><span style=\" font-size:9pt;\">Number of differnces </span></p></body></html>", self.centralwidget)
        self.number.setGeometry(QtCore.QRect(250, 550, 151, 21))
        self.number.setObjectName("number")
        self.numbervalue = QtWidgets.QLabel("<html><head/><body><p><span style=\" font-size:9pt; font-weight:600;\">0</span></p></body></html>", self.centralwidget)
    ...
    def spot_diff(self):
        ...
        # images differ
                if cv2.contourArea(c)>500 and cv2.contourArea(c)<1000:
